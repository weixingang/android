...
import com.seu.magicfilter.encoder.video.av.AudioEncoder;
import com.seu.magicfilter.encoder.video.av.AudioSoftwarePoller;
import com.seu.magicfilter.filter.base.MagicCameraInputFilter;
import com.seu.magicfilter.filter.base.gpuimage.GPUImageFilter;
import com.seu.magicfilter.filter.helper.MagicFilterFactory;
import com.seu.magicfilter.filter.helper.MagicFilterType;
import com.seu.magicfilter.encoder.video.av.VideoEncoderCore;
import java.io.File;
...
public class TextureMovieEncoder implements Runnable {
    ...
    private ImageEncoderCore imVideoEncoder;
    ...
    public static class EncoderConfig {
        ...
        public EncoderConfig(File outputFile, int width, int height, int bitRate,
                             EGLContext sharedEglContext, CameraInfo info,Context context) {
    ...
    private void prepareEncoder(EGLContext sharedContext, int width, int height, int bitRate,
        ...
        try {
            ...
            audioEncoder = new AudioEncoder(mcontext,
                    mVideoEncoder.getMediaMuxer());
            audioPoller = new AudioSoftwarePoller();
            audioPoller.setAudioEncoder(audioEncoder);
            audioEncoder.setAudioSoftwarePoller(audioPoller);
    ...
    private void prepareEncoder1(EGLContext sharedContext, int width, int height, int bitRate,
                                 File outputFile) {
        imVideoEncoder = new ImageEncoderCore(width, height, mOnImageEncoderListener);
        mVideoWidth = width;
        mVideoHeight = height;
        mEglCore = new EglCore(sharedContext, EglCore.FLAG_RECORDABLE);
        mInputWindowSurface = new WindowSurface(mEglCore, imVideoEncoder.getInputSurface(), true);
        mInputWindowSurface.makeCurrent();
    ...
    private void releaseEncoder1() {
        imVideoEncoder.release();
        if (mInputWindowSurface != null) {
            mInputWindowSurface.release();
            mInputWindowSurface = null;
        }
