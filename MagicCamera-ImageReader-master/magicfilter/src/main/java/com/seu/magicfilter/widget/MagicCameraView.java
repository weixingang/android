    ...
    private void openCamera() {
        if (CameraEngine.getCamera() == null) {
            if(CameraEngine.openCamera()) {
                ...
                CameraEngine.iscamera = true;
                mOnImageEncoderListener.onIscamera(true);

            }else{
                CameraEngine.iscamera = false;
                mOnImageEncoderListener.onIscamera(false);
    ...
    public void savePicture(final SavePictureTask savePictureTask) {
        CameraEngine.takePicture(null, null, new Camera.PictureCallback() {
            ...
            public void onPictureTaken(byte[] data, Camera camera) {
                ...
                mOnImageEncoderListener.onImageEncoder(bitmap);
