...
public class FilterMediaObject implements Serializable {
    ...
    public FilterMediaObject() {
        this.mMediaType = 0;
        this.mMaxDuration = 120000;
        this.mediaList = new LinkedList();
    }

    public FilterMediaObject(String var1, String var2) {
        this(var1, var2, 800);
    }

    public FilterMediaObject(String var1, String var2, int var3) {
        this.mMediaType = 0;
    ...
    public FilterMediaObject(String var1, String var2, int var3, int var4) {
        this.mMediaType = 0;
        this.mMaxDuration = 10000;
        this.mediaList = new LinkedList();
        this.mKey = var2;
...
//            this.mOutputObjectPath = var2;
    ...
    public static void preparedMediaObject(FilterMediaObject var0) {
