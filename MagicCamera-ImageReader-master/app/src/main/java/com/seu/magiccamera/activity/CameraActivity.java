...
import com.seu.magicfilter.encoder.video.ImageEncoderCore;
...
public class CameraActivity extends Activity {
    ...
    private void initView() {
        ...
        cameraView.setOnImageEncoderListener(new MagicCameraView.OnImageEncoderListener() {
            @Override
